...
<head>
	...
	<script type="text/javascript" src="${ctx}/sysmanage/menumanage/js/menumanage.js?version=${version}"></script>
</head>
<body>
	<!-- 正文开始 -->
	            ...
	            <div class="layui-form toolbar">
	                <div class="layui-form-item">
	                    ...
	                    <div class="layui-inline">
	                        ...
	                        <button id="refreshMenu" class="layui-btn icon-btn"><i class="layui-icon">&#xe669;</i>刷新</button>
