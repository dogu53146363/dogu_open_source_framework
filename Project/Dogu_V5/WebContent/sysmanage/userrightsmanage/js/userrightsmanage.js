...
function getUserInfo(){
	...
	$.ajax({
		type : 'post',
		url : rootPath + '/userightsmanage/getUserInfo',
		beforeSend: function () {
			showLoad();
		},
		data : {
...
function getMenuInfo(){
	...
	var setting = {
		async : {
			enable : true,
			type : 'post',
			url : rootPath + '/userightsmanage/getMenuInfo',
		// /dataFilter: filter
		},
		check : {
			enable : true,
...
function selectMenuAfterSelectedUser(account){
	...
	$.ajax({
		type : 'post',
		url : rootPath + '/userightsmanage/getSelectTreeNode',
		beforeSend: function () {
			showLoad();
		},
		data : {
...
function SaveUserLimit(){
	...
	if(selecteduserid == ""){
		...
		$.ajax({
			type : 'post',
			url : rootPath + '/userightsmanage/saveUserRights',
			beforeSend: function () {
				showLoad();
			},
			data : {
