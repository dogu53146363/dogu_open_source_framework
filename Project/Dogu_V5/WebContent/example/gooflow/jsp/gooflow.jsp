...
<link rel="stylesheet" type="text/css" href="${ctx}/example/gooflow/css/GooFlow.css?version=${version}"/>
<link rel="stylesheet" type="text/css" href="${ctx}/example/gooflow/css/default.css?version=${version}"/>
<script type="text/javascript" src="${ctx}/example/gooflow/js/GooFunc.js?version=${version}"></script>
<script type="text/javascript" src="${ctx}/example/gooflow/js/json2.js?version=${version}"></script>
<script type="text/javascript" src="${ctx}/example/gooflow/js/GooFlow.js?version=${version}"></script>
<script type="text/javascript" src="${ctx}/example/gooflow/js/GooFlow.color.js?version=${version}"></script>
<script type="text/javascript" src="${ctx}/example/gooflow/js/property.js?version=${version}"></script>
<script type="text/javascript" src="${ctx}/example/gooflow/js/gooflow_operate.js?version=${version}"></script>
</head>
