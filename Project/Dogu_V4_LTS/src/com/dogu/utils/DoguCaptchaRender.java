 ...
 * @author Dogu
 */
public class DoguCaptchaRender extends Render {
	private static final String[] strArr = { "3", "4", "5", "6", "7", "8", "9",
			"A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "M", "N", "P",
			"Q", "R", "S", "T", "U", "V", "W", "X", "Y" };

	private static String randomCodeKey = "Dogu_Key";
	...
	public DoguCaptchaRender() {
	}

	public DoguCaptchaRender(String randomKey) {
		if (StrKit.isBlank(randomKey))
			throw new IllegalArgumentException("randomKey can not be blank");
		randomCodeKey = randomKey;
	}

	public DoguCaptchaRender(int width, int height, int count,
	...
	public DoguCaptchaRender(String randomKey, int width, int height, int count,
			boolean isCaseInsensitive) {
		if (StrKit.isBlank(randomKey))
			throw new IllegalArgumentException("randomKey can not be blank");
		randomCodeKey = randomKey;
