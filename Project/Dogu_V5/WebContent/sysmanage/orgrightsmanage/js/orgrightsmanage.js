...
function getOrgZtreeInfo(){
	...
	var setting = {
		async : {
			enable : true,
			type : 'post',
			url : rootPath + '/orgrightsmanage/getOrgInfo',
			otherParam: []
		},
		check : {
			enable : false,
...
function getMenuZtreeInfo(){
	...
	var setting = {
		async : {
			enable : true,
			type : 'post',
			url : rootPath + '/orgrightsmanage/getMenuInfo',
		// /dataFilter: filter
		},
		check : {
			enable : true,
...
function selectMenuAfterSelectedOrg(account){
	...
	$.ajax({
		type : 'post',
		url : rootPath + '/orgrightsmanage/getSelectTreeNode',
		beforeSend: function () {
			showLoad();
		},
		data : {
...
function SaveOrgLimit(){
	...
	if(selectedOrgId == ""){
		...
		$.ajax({
			type : 'post',
			url : rootPath + '/orgrightsmanage/saveOrgRights',
			beforeSend: function () {
				showLoad();
			},
			data : {
...
function getLimitType(){
	$.ajax({
		type : 'post',
		url : rootPath + '/orgrightsmanage/getRightsType',
		beforeSend: function () {
			showLoad();
		},
		data : {
