...
<link rel="shortcut icon" href="${ctx}/common/index/ico/favicon.ico" /> 
<link rel="stylesheet" href="${ctx}/common/index/css/index.css?version=${version}">
<script type="text/javascript" src="${ctx}/common/index/js/index.js?version=${version}"></script>
