...
<head>
	...
	<script src="${ctx}/common/lib/cron/Cron/jquery-1.6.2.min.js" type="text/javascript"></script>
	<script src="${ctx}/common/lib/cron/Cron/jquery.easyui.min.js" type="text/javascript"></script>
	<script src="${ctx}/common/lib/cron/Cron/cron.js" type="text/javascript"></script>
	<link href="${ctx}/common/lib/cron/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/common/lib/cron/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/common/lib/cron/Cron/icon.css" rel="stylesheet" type="text/css" />
	<style type="text/css">
		.line {
			height: 25px;
			line-height: 25px;
					...
					<table style="height: 100px;">
						<tbody>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="确定" id="btnFan"
									onclick="sure()" /></td>
							</tr>
						</tbody>
					</table>
