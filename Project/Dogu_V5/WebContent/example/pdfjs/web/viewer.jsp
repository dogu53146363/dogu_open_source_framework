...
<link rel="stylesheet" href="${ctx}/example/pdfjs/web/viewer.css">
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="locale/locale.properties">
<script src="${ctx}/example/pdfjs/build/pdf.js"></script>
<script src="${ctx}/example/pdfjs/web/alert.js"></script>
<script src="${ctx}/example/pdfjs/web/viewer.js"></script>
</head>
