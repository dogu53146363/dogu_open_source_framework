    ...
    admin.events = {
        ...
        theme: function () {
            ...
            ta.popupRight({
                id: 'layer-theme',
                type: 2,
                content: url ? url : rootPath+'/SYSTEM/main/jsp/main-them.jsp'
            });
        },
        // 打开便签
        note: function () {
            ...
            ta.popupRight({
                ...
                type: 2,
                closeBtn: false,
                content: url ? url : rootPath+'/SYSTEM/main/jsp/main-note.jsp'
            });
        },
        // 打开消息
        message: function () {
            ...
            ta.popupRight({
                id: 'layer-notice',
                type: 2,
                content: url ? url : rootPath+'/SYSTEM/main/jsp/main-message.jsp'
            });
        },
        info: function () {
            getUserInfo();
