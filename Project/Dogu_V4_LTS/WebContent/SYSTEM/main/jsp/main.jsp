...
<head>
	...
	<!-- 图标库css -->
	<link rel="stylesheet" type="text/css" href="${ctx}/SYSTEM/lib/font-awesome/css/font-awesome.min.css?version=${version}"/>
		...
		<div class="layui-layout layui-layout-admin">
		    ...
		    <div class="layui-header">
		        <div class="layui-logo">
		            <img src="${ctx}/SYSTEM/main/img/logo.png"/>
		            &nbsp;&nbsp;
		            <cite>Dogu开源框架</cite>
		        </div>
		        ...
		        <ul class="layui-nav layui-layout-right">
		            ...
		            <li class="layui-nav-item" lay-unselect>
		                <a>
		                    <img src="${ctx}/SYSTEM/main/img/user.png" class="layui-nav-img">
		                    <cite><%=UserName%></cite>
		                </a>
