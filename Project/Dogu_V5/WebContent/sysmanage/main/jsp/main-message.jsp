	...
	<div class="layui-tab layui-tab-brief"
		...
		<div class="layui-tab-content" style="padding: 5px 0;">
			...
			<div class="layui-tab-item layui-show">
				...
				<div class="message-list">
					...
					<a class="message-list-item" href="javascript:;"> <img
						class="message-item-icon" src="${ctx}/sysmanage/main/img/message.png">
					...
					<div class="message-list-empty" style="display: none;">
						<img src="${ctx}/sysmanage/main/img/img_msg_notice.svg">
						<div>没有通知</div>
					</div>
			...
			<div class="layui-tab-item">
				<div class="message-list">
					<a class="message-list-item" href="javascript:;"> <img
						class="message-item-icon" src="${ctx}/sysmanage/main/img/head.png">
						<div class="message-item-right">
					...
					<!-- 列表为空 -->
					<div class="message-list-empty" style="display: none;">
						<img src="${ctx}/sysmanage/main/img/img_msg_pri.svg">
						<div>没有消息</div>
					</div>
			...
			<div class="layui-tab-item">
				...
				<div class="message-list">
					...
					<!-- 列表为空 -->
					<div class="message-list-empty" style="display: none;">
						<img src="${ctx}/sysmanage/main/img/img_msg_db.svg">
						<div>没有待办</div>
					</div>
				</div>
