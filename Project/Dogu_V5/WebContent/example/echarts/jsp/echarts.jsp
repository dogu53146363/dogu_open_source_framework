...
<script type="text/javascript" src="${ctx}/example/echarts/js/echartsrequire.js?version=${version}"></script>
<script type="text/javascript" src="${ctx}/example/echarts/js/echarts.min.js?version=${version}"></script>
</head>
<body>
