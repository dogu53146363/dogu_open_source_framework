...
<!-- 通用css -->
<link rel="stylesheet" type="text/css" href="${ctx}/SYSTEM/common/css/common.css?version=${version}"/>
<!-- js引用的版本号 -->
<script type="text/javascript">var version=${version};</script>
<!-- jquery -->
<script type="text/javascript" src="${ctx}/SYSTEM/lib/jquery/3.4.1/jquery-3.4.1.min.js?version=${version}"></script>
<!-- layui -->
<script type="text/javascript" src="${ctx}/SYSTEM/lib/layui/layui.js?version=${version}"></script>
<!-- 通用js -->
<script type="text/javascript" src="${ctx}/SYSTEM/common/js/common.js?version=${version}"></script>
